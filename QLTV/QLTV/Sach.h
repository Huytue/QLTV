...
public:
	...
	Sach(string sMaSach = "", string sTuaDe = "", string sTacGia = "",
		string sNXB = "", float fTriGia = 0.0, int nNamPhatHanh = 0, int nSoTrang = 0,
		int nNgay = 0, int nThang = 0, int nNam = 0, int nTinhTrang = 0) :xNgayNhapKho(nNgay, nThang, nNam)
	{
